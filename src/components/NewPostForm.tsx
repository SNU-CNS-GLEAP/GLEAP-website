...
export function NewPostForm({ locale, labels }: Props) {
  ...
  return (
    <form onSubmit={onSubmit} className="flex max-w-2xl flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={pending}
        className="w-fit rounded bg-primary px-4 py-2 text-sm font-medium text-white disabled:cursor-not-allowed disabled:opacity-60"
      >
